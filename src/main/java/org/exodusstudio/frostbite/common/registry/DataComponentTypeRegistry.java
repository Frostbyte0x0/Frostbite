...
public class DataComponentTypeRegistry {
    ...
    public static final Supplier<DataComponentType<MapStringIntData>> MAP_STRING_INT = DATA_COMPONENT_TYPES.registerComponentType("map_string_int",
            builder -> builder.persistent(MapStringIntData.CODEC).networkSynchronized(MapStringIntData.STREAM_CODEC));
