...
public interface Renderable {
    ...
    static void addRenderable(LivingEntity user, String renderable) {
        Map<UUID, List<Pair<String, Long>>> currentCharges = new HashMap<>(user.level().getData(AttachmentRegistry.CURRENT_RENDERING_ATTACKS));
        ...
        user.level().setData(AttachmentRegistry.CURRENT_RENDERING_ATTACKS, currentCharges);
    }
