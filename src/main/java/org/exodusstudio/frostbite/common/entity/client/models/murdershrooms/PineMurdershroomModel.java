...
public class PineMurdershroomModel extends EntityModel<LivingEntityRenderState> {
    private final ModelPart murdershroom;
    private final ModelPart head;

    public PineMurdershroomModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(LivingEntityRenderState renderState) {
        ...
        //this.animateWalk(PineMurdershroomAnimations.WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
        //this.animate(entity.idleAnimationState, PineMurdershroomAnimations.IDLE, ageInTicks, 1f);
    }
