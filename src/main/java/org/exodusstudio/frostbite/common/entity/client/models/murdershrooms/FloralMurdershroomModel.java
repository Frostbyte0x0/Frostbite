...
public class FloralMurdershroomModel extends EntityModel<LivingEntityRenderState> {
    private final ModelPart murdershroom;
    private final ModelPart head;

    public FloralMurdershroomModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(LivingEntityRenderState renderState) {
        ...
        //this.animateWalk(FloralMurdershroomAnimations.WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
        //this.animate(entity.idleAnimationState, FloralMurdershroomAnimations.IDLE, ageInTicks, 1f);
    }
