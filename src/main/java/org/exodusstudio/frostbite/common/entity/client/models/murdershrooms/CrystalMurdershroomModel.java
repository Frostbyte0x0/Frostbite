...
public class CrystalMurdershroomModel extends EntityModel<LivingEntityRenderState> {
    private final ModelPart murdershroom;
    private final ModelPart head;

    public CrystalMurdershroomModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(LivingEntityRenderState renderState) {
        ...
        //this.animateWalk(CrystalMurdershroomAnimations.WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
        //this.animate(entity.idleAnimationState, CrystalMurdershroomAnimations.IDLE, ageInTicks, 1f);
    }
