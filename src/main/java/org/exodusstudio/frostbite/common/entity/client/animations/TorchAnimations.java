...
public class TorchAnimations {
    public static final AnimationDefinition SLICE = AnimationDefinition.Builder.withLength(1.0F)
            .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(-90.0F, -40.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(-90.0F, 52.5F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
