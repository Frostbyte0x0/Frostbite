...
public class DecayingMurdershroomModel extends EntityModel<LivingEntityRenderState> {
    private final ModelPart murdershroom;
    private final ModelPart head;

    public DecayingMurdershroomModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(LivingEntityRenderState renderState) {
        ...
        //this.animateWalk(DecayingMurdershroomAnimations.WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
        //this.animate(entity.idleAnimationState, DecayingMurdershroomAnimations.IDLE, ageInTicks, 1f);
    }
