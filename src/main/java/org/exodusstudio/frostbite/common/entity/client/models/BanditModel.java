...
public class BanditModel extends QuadrupedModel<BanditRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        all.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(28, 27).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 0.0F, 6.0F));
        ...
        all.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -9.0F, -1.0F, 10.0F, 6.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 0.0F, -6.0F));
        ...
        all.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(20, 20).addBox(-1.0F, -8.0F, 7.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
