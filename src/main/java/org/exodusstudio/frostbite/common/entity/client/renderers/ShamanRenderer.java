...
public class ShamanRenderer extends MobRenderer<ShamanEntity, ShamanRenderState, ShamanModel> {
    ...
    @Override
    public void extractRenderState(ShamanEntity guard, ShamanRenderState state, float p_361157_) {
        ...
        state.showShield = guard.isShowingShield();
    }

    @Override
    public Identifier getTextureLocation(ShamanRenderState renderState) {
