...
public class WoollySheepModel extends QuadrupedModel<SheepRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        body.addOrReplaceChild("rotation", CubeListBuilder.create().texOffs(20, 4).addBox(-6.0F, -12.0F, -10.0F, 12.0F, 20.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
        ...
        head2.addOrReplaceChild("mirror", CubeListBuilder.create().texOffs(2, 61).mirror().addBox(2.5F, -21.0F, -10.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-0.5F, 10.0F, 0.0F));
        head.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(34, 46).addBox(-3.0F, -4.0F, -8.0F, 5.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -20.0F, -9.0F, 0.9599F, 0.0F, 0.0F));
        head.addOrReplaceChild("right_horn", CubeListBuilder.create().texOffs(12, 55).addBox(-2.99F, -16.0F, -10.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, -12.0F, -1.0F));
        head.addOrReplaceChild("left_horn", CubeListBuilder.create().texOffs(12, 55).addBox(-0.01F, -16.0F, -10.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, -12.0F, -1.0F));
    ...
    public void setupAnim(SheepRenderState p_360805_) {
        ...
        this.head.y += p_360805_.headEatPositionScale * 9 * p_360805_.ageScale;
