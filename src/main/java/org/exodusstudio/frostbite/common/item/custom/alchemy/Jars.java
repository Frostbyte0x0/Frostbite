...
public class Jars {
    ...
    public static final Holder<Jar> FLORAL = register("floral",
            new Jar("floral", new MobEffectInstance(EffectRegistry.IRRITATION, 3600))); // infinite duration
    ...
    public static final Holder<Jar> LIGHT = register("light",
            new Jar("light", new MobEffectInstance(EffectRegistry.PARALYSIS, 3600)));
    ...
    public static Optional<Holder<Jar>> jarFromEffect(Holder<MobEffect> effect) {
        ...
        if (effect.is(EffectRegistry.PARALYSIS)) {
