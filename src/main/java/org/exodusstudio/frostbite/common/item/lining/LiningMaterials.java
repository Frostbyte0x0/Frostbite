...
public interface LiningMaterials {
    LiningMaterial WOOL = new LiningMaterial(15, Util.make(new EnumMap<>(ArmorType.class), (map) -> {
    ...
    LiningMaterial WOOLLY_WOOL = new LiningMaterial(25, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    LiningMaterial FROZEN_FUR = new LiningMaterial(35, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    LiningMaterial INSULATED_CLOTH = new LiningMaterial(45, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    LiningMaterial HEATED_COATING = new LiningMaterial(55, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    LiningMaterial FROZEN_PLATING = new LiningMaterial(65, Util.make(new EnumMap<>(ArmorType.class), map -> {
