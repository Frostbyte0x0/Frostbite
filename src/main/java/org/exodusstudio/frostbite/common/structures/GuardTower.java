...
public class GuardTower extends Structure {
    public static final MapCodec<GuardTower> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(GuardTower.settingsCodec(instance),
    ...
    public GuardTower(StructureSettings config,
    ...
    public StructureType<?> type() {
        return StructureRegistry.GUARD_TOWER.get();
    }
}
