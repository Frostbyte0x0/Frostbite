...
public record ContractAttributeData(ContractAttribute attribute) {
    public static final Codec<ContractAttributeData> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(ContractAttribute.CODEC.fieldOf("attribute").forGetter(ContractAttributeData::attribute))
